        ...
        <section>
            ...
            <div id="experience">
                ...
                <div id="exp">
                        ...
                        <div class="emploi">
                            <div class="date">2017  (de mi-janvier  à fin décembre)  
                            </div>
                            <div class="poste"><h4>Gestionnaire de production <em>intérimaire</em></h4>
                                NEXTER SYSTEMS <br/>
                                Bourges (18) <br/>
                        ...
                        <div class="emploi">
                            <div class="date">2015-2016   (16 semaines)
                            </div>
                            <div><h4>Attachée logistique stagiaire </h4>
                        ...
                        <div class="emploi"> 
                            <div class="date"> nov 1999 - sept 2016
                            </div>   
                            <div><h4>Technicienne laboratoire</h4>
                        ...
                        <div class="emploi">
                            <div class="date"> févr-déc 1998 <br>
                               <!-- <em> (remplacement de congé maternité puis parental)</em> -->
                            </div>
                            <div><h4>Technicienne analyses biologiques </h4>
                                Laboratoire de la laiterie TRIBALLAT <br/>
                                Rians (18)
                            </div>
                        </div>                   
                        <div class="emploi"> 
                            <div class="date"> avril, juil-août 1996  <br>
                        ...
                        <div class="emploi">  
                            <div class="date">oct 1990- juil 1995
                            </div>
                            <div><h4>Technicienne analyses biologiques </h4>
